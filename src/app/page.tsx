      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {/* Personal Project Card 4 */}
            <div className="border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow h-full">
              <h3 className="text-xl font-semibold text-gray-900 mb-2">MCS Techonologies</h3>
              <a href="https://mcsltd.io" className="text-blue-600 hover:text-blue-900 text-sm">Check it out</a>
              <p className="text-gray-600 mb-4">
                Simple landing page for MCS Technologies using Vite.JS Framework, HTML, Tailwind CSS & JavaScript.
              </p>
              <div className="flex gap-2">
              <span className="px-3 py-1 bg-orange-100 text-orange-800 rounded-full text-sm">Cloudflare</span>
                <span className="px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm">Vite.js</span>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between mb-3">
                <h3 className="text-xl font-semibold text-gray-900">MCS Technologies</h3>
                <a href="https://github.com/mitch478/mcsltd.io" className="text-gray-600 hover:text-gray-900">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 0C5.374 0 0 5.373 0 12 0 17.302 3.438 21.8 8.207 23.387c.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23A11.509 11.509 0 0112 5.803c1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576C20.566 21.797 24 17.3 24 12c0-6.627-5.373-12-12-12z"/>
                  </svg>
                </a>
